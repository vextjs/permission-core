...
- [MemoryAdapter](/api/memory-adapter)
- [FileAdapter](/api/file-adapter)
- [MonSQLizeStorageAdapter](/api/monsqlize-storage-adapter)

## 更适合从哪里继续看

- 如果你想先选现成适配器：继续看 [存储适配器](/guide/adapters)
- 如果你要自己实现：继续看 [自定义适配器](/guide/custom-adapter)
