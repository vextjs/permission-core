...
- [PermissionCoreContext](/zh/api/context)
- [RoleManager](/zh/api/role-manager)
- [UserRoleManager](/zh/api/user-roles)
...
- 想理解接口和数据权限怎么分层：看 [框架接入](/zh/guide/framework-integration)
- 想看错误如何映射到接口响应：看 [错误处理与响应映射](/zh/guide/error-response-mapping)
- 想先解开接入中的高频疑问：看 [常见问题](/zh/guide/faq)