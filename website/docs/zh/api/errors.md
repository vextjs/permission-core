...
| 409 | `REVISION_CONFLICT`、`CURSOR_STALE`、`IDEMPOTENCY_CONFLICT`、`PREVIEW_REQUIRED`、`PREVIEW_STALE`、`MENU_MANAGEMENT_PREVIEW_CONFLICT`、`ROLE_ALREADY_EXISTS`、`ROLE_IN_USE`、`CIRCULAR_INHERITANCE`、`MENU_ALREADY_EXISTS`、`DEPENDENCY_EXISTS`、`API_BINDING_ALREADY_EXISTS`、`STALE_REFERENCE` |
