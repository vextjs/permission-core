...
如果你使用的是 vext，可继续看 [vext 接入](/examples/vext)。

## 下一步看什么

- 想先确认真实接入前有没有漏项：看 [接入检查清单](/guide/integration-checklist)
- 想回到更通用的分层说明：看 [框架接入](/guide/framework-integration)
- 想继续看 vext 版本的接法：看 [vext 接入](/examples/vext)