...
export const docsPages = [
    ...
    page("api-bindings", "guide/api-bindings.md", 8, "guide", "tasks", { en: "Bind APIs", zh: "绑定接口" }, "how-to", ["src/menu/api-mutations.ts", "src/types/menu.ts"], { sourceSymbol: "ApiBindingManager", contentOwner: "api-binding-workflow", reuseMode: "generated-response", primaryNext: "guide/role-menu-authorization.md" }),
    ...
    page("menus-api", "api/menus.md", 21, "api", "api", { en: "Menus", zh: "菜单 API" }, "reference", ["src/types/menu.ts", "src/rbac/public-context.ts"], { sourceSymbol: "MenuManager", contentOwner: "menus-api", primaryNext: "api/api-bindings.md" }),
    page("api-bindings-api", "api/api-bindings.md", 22, "api", "api", { en: "API Bindings", zh: "接口绑定 API" }, "reference", ["src/types/menu.ts", "src/rbac/public-context.ts"], { sourceSymbol: "ApiBindingManager", contentOwner: "api-bindings-api", primaryNext: "api/role-menu-permissions.md" }),
    page("role-menu-permissions-api", "api/role-menu-permissions.md", 23, "api", "api", { en: "Role Menu Permissions", zh: "角色菜单权限 API" }, "reference", ["src/types/menu.ts", "src/menu/role-menu-mutations.ts"], { sourceSymbol: "RoleMenuPermissionManager", contentOwner: "role-menu-api", primaryNext: "api/authorized-collection.md" }),
    ...
    page("vext-plugin-api", "api/vext-plugin.md", 29, "api", "api", { en: "Vext Plugin API", zh: "Vext 插件 API" }, "reference", ["src/plugins/vext/index.ts", "src/plugins/vext/types.ts"], { sourceSymbol: "permissionPlugin", contentOwner: "vext-api", primaryNext: "examples/basic.md" }),
