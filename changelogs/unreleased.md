...
- Aligned README and website examples with the current RoleManager API, fixed local English docs paths, and refreshed the verified test count to 66.
- Updated the security support matrix and profile npm latest metadata to the current `1.0.10` line.
...
- Synchronized the documentation nav version label with `v1.0.10`.
